...
class Onboarding {
  ...
  factory Onboarding.of(AppLanguage language) =>
      Onboarding._(language == AppLanguage.bangla);
  ...
  String get roleDisabledUserLabel =>
      _t('I need assistance', 'আমার সহায়তা প্রয়োজন');
  String get roleDisabledUserDescription => _t(
    'Set up navigation help for myself.',
    'নিজের জন্য পথ দেখানোর সাহায্য সেট করুন।',
  );
  ...
  String get roleCaretakerLabel =>
      _t('I am a Caretaker', 'আমি একজন দেখাশোনাকারী');
  String get roleCaretakerDescription => _t(
    'Set up remote monitoring for someone I support.',
    'আমি যাকে দেখাশোনা করি, দূর থেকে তার খেয়াল রাখতে এটি সেট করুন।',
  );
  ...
  String get caretakerPairingTitle => _t(
    'Share this code with your Disabled User\'s device',
    'এই কোডটি যাকে দেখাশোনা করেন তার ফোনে দেখান',
  );
  String get caretakerPairingGenerating =>
      _t('Generating code', 'কোড তৈরি হচ্ছে');
  String caretakerPairingYourCode(String code) =>
      _t('Your pairing code is $code', 'আপনার কোড হলো $code');
  String get caretakerPairingWaiting => _t(
    'Waiting for them to enter this code...',
    'তিনি এই কোডটি দেওয়ার অপেক্ষায়...',
  );

  // Paired confirmation (caretaker side)
  String get pairedConfirmationTitle =>
      _t('Paired successfully!', 'যুক্ত হয়ে গেছে!');
  ...
  String get userPairingTitle =>
      _t('Enter your caretaker\'s code', 'দেখাশোনাকারীর কোড লিখুন');
  ...
  String get userPairingCodeFieldLabel =>
      _t('Enter the 6 digit pairing code', 'ছয় সংখ্যার কোড লিখুন');
  String get userPairingNoCaretakerButton =>
      _t('I don\'t have a caretaker', 'আমার কোনো দেখাশোনাকারী নেই');
  ...
  String get userPairingNoCaretakerSemantics => _t(
    'I don\'t have a caretaker, continue without pairing',
    'আমার কোনো দেখাশোনাকারী নেই, এটি বাদ দিয়ে চালিয়ে যান',
  );
  ...
  // Vision question
  String get visionTitle => _t(
    'Do you have any vision difficulty?',
    'আপনার কি চোখে কোনো সমস্যা আছে?',
  );
  String get visionSubtitle => _t(
    'This helps us adjust the screen and voice guidance for you.',
    'এটি আমাদের স্ক্রিন ও ভয়েস আপনার জন্য ঠিক করতে সাহায্য করবে।',
  );
  String get visionNoneLabel => _t('No vision', 'দৃষ্টিশক্তি নেই');
  String get visionNoneDescription => _t(
    'I rely entirely on voice and touch.',
    'আমি পুরোপুরি ভয়েস আর স্পর্শের উপর নির্ভর করি।',
  );
  ...
  String get visionLowLabel =>
      _t('Partial / low vision', 'আংশিক / কম দৃষ্টিশক্তি');
  String get visionLowDescription => _t(
    'I can see some things, but need larger text and higher contrast.',
    'আমি কিছুটা দেখতে পাই, তবে বড় লেখা আর বেশি কনট্রাস্ট লাগে।',
  );
  ...
  String get visionFullDescription => _t(
    'I see well and don\'t need visual adjustments.',
    'আমি ভালো দেখতে পাই, কিছু পাল্টানোর দরকার নেই।',
  );
  ...
  // Visual calibration
  String get calibrationTitle => _t(
    'Let\'s adjust the display for you',
    'চলুন স্ক্রিন আপনার জন্য ঠিক করি',
  );
  String get calibrationSubtitle => _t(
    'Move the sliders until the text below is easy for you to read.',
    'নিচের লেখাটি সহজে পড়া না যাওয়া পর্যন্ত স্লাইডার সরান।',
  );
  String get calibrationPreviewText =>
      _t('ANT will guide you safely.', 'অ্যান্ট আপনাকে নিরাপদে পথ দেখাবে।');
  String get calibrationContrastLabel => _t('Contrast', 'কনট্রাস্ট');
  String calibrationContrastSemantics(int percent) => _t(
    'Contrast level slider, currently $percent percent',
    'কনট্রাস্টের স্লাইডার, এখন $percent শতাংশ',
  );
  String get calibrationTextSizeLabel => _t('Text size', 'লেখার আকার');
  String calibrationTextSizeSemantics(String scale) => _t(
    'Text size slider, currently $scale times normal size',
    'লেখার আকারের স্লাইডার, এখন স্বাভাবিকের $scale গুণ',
  );
  String get calibrationContinueButton =>
      _t('This is comfortable, continue', 'এটি আরামদায়ক, চালিয়ে যান');
  List<String> get calibrationContinueSynonyms => _bn
      ? const ['আরামদায়ক', 'ঠিক আছে', 'চালিয়ে যান']
      : const ['comfortable', 'good', 'fine', 'continue', 'done'];
  ...
  String get themeSubtitle => _t(
    'Pick whichever is easier on your eyes. You can change this later just by asking the AI.',
    'যেটি আপনার চোখের জন্য আরামদায়ক সেটি বেছে নিন। পরে শুধু AI-কে বললেই এটি পাল্টাতে পারবেন।',
  );
  String get themeLightLabel => _t('Light', 'হালকা');
  String get themeLightDescription => _t(
    'Soft cream background, dark text.',
    'হালকা ক্রিম রঙের পটভূমি, গাঢ় লেখা।',
  );
  List<String> get themeLightSynonyms => _bn
      ? const ['সাদা', 'উজ্জ্বল', 'দিনের মোড']
      : const ['bright', 'white', 'day mode'];
  ...
  // they cannot see.
  String get autoListenTitle => _t(
    'Should the microphone open on its own?',
    'মাইক কি নিজে থেকেই চালু হবে?',
  );
  ...
  String get autoListenYesLabel =>
      _t('Yes, open it for me', 'হ্যাঁ, নিজেই চালু হোক');
  String get autoListenYesDescription => _t(
    'Best if tapping a small button is hard.',
    'ছোট বোতামে চাপ দেওয়া কঠিন হলে এটাই ভালো।',
  );
  List<String> get autoListenYesSynonyms => _bn
      ? const ['হ্যাঁ', 'চালু', 'নিজেই']
      : const ['yes', 'open it', 'automatic', 'on'];
  String get autoListenNoLabel =>
      _t('No, I will tap the mic', 'না, আমি মাইকে চাপব');
  String get autoListenNoDescription => _t(
    'The microphone only opens when you ask.',
    'আপনি না চাইলে মাইক চালু হবে না।',
  );
  List<String> get autoListenNoSynonyms => _bn
      ? const ['না', 'আমি চাপব', 'বন্ধ']
      : const ['no', 'i will tap', 'manual', 'off'];
  ...
  String get optionNarrationAlwaysLabel =>
      _t('Read them every time', 'প্রতিবার পড়ে শোনাও');
  ...
  String get optionNarrationOnRequestLabel =>
      _t('Only when I ask', 'শুধু আমি চাইলে');
  ...
  String get optionNarrationKeywordHint => _t(
    'Say "options" to hear the choices.',
    '"বিকল্প" বললে পছন্দগুলো শুনতে পাবেন।',
  );

  String get themeDarkLabel => _t('Dark', 'গাঢ়');
  String get themeDarkDescription => _t(
    'Deep charcoal background, soft white text.',
    'গাঢ় কালচে পটভূমি, নরম সাদা লেখা।',
  );
  List<String> get themeDarkSynonyms => _bn
      ? const ['কালো', 'রাতের মোড', 'গাঢ় রং']
      : const ['black', 'night mode', 'night'];

  // Mobility
  String get mobilityTitle =>
      _t('How do you get around?', 'আপনি কীভাবে চলাফেরা করেন?');
  String get mobilitySubtitle => _t(
    'This helps us choose routes that work for you.',
    'এটি আমাদের আপনার জন্য ঠিক পথ বেছে নিতে সাহায্য করে।',
  );
  String get mobilityWhiteCaneLabel => _t('White cane', 'সাদা ছড়ি');
  List<String> get mobilityWhiteCaneSynonyms =>
      _bn ? const ['ছড়ি', 'লাঠি'] : const ['cane', 'stick', 'blind cane'];
  String get mobilityWheelchairLabel => _t('Wheelchair', 'হুইলচেয়ার');
  List<String> get mobilityWheelchairSynonyms =>
      _bn ? const ['চেয়ার', 'হুইল চেয়ার'] : const ['chair', 'wheel chair'];
  String get mobilityUnassistedLabel =>
      _t('I walk unassisted', 'আমি সাহায্য ছাড়াই হাঁটি');
  ...
  String get cognitiveTitle =>
      _t('A couple more questions', 'আরও কয়েকটি প্রশ্ন');
  String get cognitiveSubtitle => _t(
    'There are no wrong answers here — this only helps us keep things calm for you.',
    'এখানে কোনো ভুল উত্তর নেই — এটি শুধু আপনাকে শান্ত রাখতে সাহায্য করবে।',
  );
  String get cognitiveCrowdedQuestion => _t(
    'Do crowded places make you feel anxious?',
    'ভিড়ের জায়গায় কি আপনার অস্বস্তি লাগে?',
  );
  String get cognitiveComplexQuestion => _t(
    'Do you find complex, multi-step instructions hard to follow?',
    'অনেক ধাপের কঠিন নির্দেশ বুঝতে কি আপনার অসুবিধা হয়?',
  );
  ...
  // Deaf/hearing
  String get deafTitle => _t(
    'Are you deaf or hard of hearing?',
    'আপনি কি কানে কম শোনেন বা একদম শোনেন না?',
  );
  String get deafSubtitle => _t(
    'If so, we\'ll show you text and visual guidance instead of relying on audio.',
    'তাহলে আমরা শব্দের বদলে লেখা ও ছবি দিয়ে বোঝাব।',
  );
  String get deafYesLabel => _t('Yes', 'হ্যাঁ');
  String get deafYesDescription => _t(
    'Show me text and visuals instead of audio.',
    'শব্দের বদলে আমাকে লেখা এবং ছবি দেখান।',
  );
  String get deafNoLabel => _t('No', 'না');
  String get deafNoDescription => _t(
    'I can hear voice guidance normally.',
    'আমি সহকারীর কথা স্বাভাবিকভাবে শুনতে পাই।',
  );
  ...
  // Verbosity & voice
  String get verbosityTitle =>
      _t('How should the AI talk to you?', 'AI আপনার সাথে কীভাবে কথা বলবে?');
  ...
  String get verbosityMinimalistDescription =>
      _t('Short, essential instructions only.', 'শুধু ছোট, দরকারি কথা বলবে।');
  List<String> get verbosityMinimalistSynonyms => _bn
      ? const ['কম কথা', 'ছোট', 'সংক্ষেপে']
      : const ['short', 'brief', 'less talking', 'minimal'];
  String get verbosityDescriptiveLabel => _t('Descriptive', 'বিস্তারিত');
  String get verbosityDescriptiveDescription => _t(
    'More detail and reassurance along the way.',
    'পথে আরও বিস্তারিত কথা আর ভরসা দেবে।',
  );
  List<String> get verbosityDescriptiveSynonyms => _bn
      ? const ['বেশি কথা', 'বিস্তারিত', 'খুলে বলা']
      : const ['detailed', 'more talking', 'long', 'descriptive'];
  ...
  String get verbosityFemaleVoiceLabel => _t(
    '$_voiceLanguageName — Female voice',
    '$_voiceLanguageName — নারী কণ্ঠ',
  );
  List<String> get verbosityFemaleVoiceSynonyms => _bn
      ? const ['নারী', 'মেয়ে', 'মহিলা']
      : const ['female', 'woman', 'girl'];
  String get verbosityMaleVoiceLabel => _t(
    '$_voiceLanguageName — Male voice',
    '$_voiceLanguageName — পুরুষ কণ্ঠ',
  );
  List<String> get verbosityMaleVoiceSynonyms =>
      _bn ? const ['পুরুষ', 'ছেলে'] : const ['male', 'man', 'boy'];
  ...
  String get contactsTitle => _t(
    'Who should we contact in an emergency?',
    'বিপদে পড়লে আমরা কাকে জানাব?',
  );
  String get contactsSubtitle => _t(
    'Add at least one trusted contact. They\'ll get an SMS with your location if you press the Magic Button.',
    'অন্তত একজন বিশ্বস্ত মানুষের নাম দিন। আপনি ম্যাজিক বাটন চাপলে তিনি আপনার অবস্থানসহ একটি SMS পাবেন।',
  );
  ...
  String get contactsErrorAtLeastOne => _t(
    'Please add at least one trusted contact for the Magic Button to work.',
    'ম্যাজিক বাটন কাজ করার জন্য অন্তত একজনের নাম দিন।',
  );
  String get contactsSpokenHint => _t(
    'Add a contact by entering a name and phone number, or search your phone contacts by name or number. '
        'The contact search also has voice input and a manual entry option. Add at least one, then tap Continue.',
    'নাম ও ফোন নম্বর লিখে যোগাযোগ যোগ করুন, অথবা ফোনের পরিচিতিতে নাম বা নম্বর দিয়ে খুঁজুন। '
        'পরিচিতি খোঁজায় ভয়েস ইনপুট ও হাতে লেখার ব্যবস্থাও আছে। অন্তত একজন যোগ করে চালিয়ে যান চাপুন।',
  );
  String contactsRemoveSemantics(String name) =>
      _t('Remove $name', '$name বাদ দিন');
  String get contactsNamePromptSpoken =>
      _t('Say the contact\'s name.', 'পরিচিতির নাম বলুন।');
  String get contactsPhonePromptSpoken =>
      _t('Now say their phone number.', 'এখন তাদের ফোন নম্বর বলুন।');
  String get contactsAddAnotherLabel => _t('Add another', 'আরেকজন যোগ করুন');
  List<String> get contactsAddAnotherSynonyms => _bn
      ? const ['আরেকজন', 'আরও একজন', 'আরও']
      : const ['another', 'one more', 'add', 'add one more'];
  ...
  // Passerby messages
  String get passerbyTitle => _t(
    'What might you need to tell a stranger?',
    'অচেনা মানুষকে আপনার কী বলার দরকার হতে পারে?',
  );
  ...
  String get passerbyWriteOwnHint =>
      _t('Write or dictate your own…', 'নিজে লিখুন বা বলুন…');
  ...
  String get passerbySpeakHint => _t(
    'Voice input arrives with the AI Assistant module',
    'কথা বলে লেখার অংশটি পরে যোগ হবে',
  );
  String get passerbyAiSummaryLabel =>
      _t('AI summary (this is what gets added)', 'ছোট করে লেখা (এটাই যোগ হবে)');
  String get passerbyWriteFieldSemantics =>
      _t('Write your own message', 'নিজের বার্তা লিখুন');
  String passerbySpokenPreselected(String messages) => _t(
    'The first 3 below are pre-selected: $messages.',
    'নিচের প্রথম ৩টি আগে থেকেই বাছাই করা আছে: $messages।',
  );
  String passerbySpokenMore(String messages) =>
      _t('More options follow: $messages.', 'আরও কিছু বিকল্প আছে: $messages।');
  ...
  String passerbyMessageAddedSpoken(String message) =>
      _t('Added: $message.', 'যোগ হয়েছে: $message।');
  String passerbyMessageRemovedSpoken(String message) =>
      _t('Removed: $message.', 'বাদ দেওয়া হয়েছে: $message।');
  String get passerbyCustomAddedSpoken =>
      _t('Added your message.', 'আপনার বার্তা যোগ হয়েছে।');
  ...
  String get passerbyAddOwnButton =>
      _t('Add this message', 'এই বার্তাটি যোগ করুন');
  String get passerbyAddOwnPromptSpoken =>
      _t('Okay, say your message now.', 'ঠিক আছে, এখন আপনার বার্তা বলুন।');
  ...
  String get passerbyNeedHelp =>
      _t('I need help, please.', 'আমার সাহায্য দরকার, দয়া করে।');
  String get passerbyWhichDirection =>
      _t('Which direction is this address?', 'এই ঠিকানাটি কোন দিকে?');
  String get passerbyHelpCross => _t(
    'Can you help me cross the street?',
    'আমাকে রাস্তা পার হতে একটু সাহায্য করবেন?',
  );
  String get passerbyVisuallyImpaired => _t(
    'I am visually impaired. Can you guide me?',
    'আমি চোখে দেখি না। আমাকে একটু পথ দেখাবেন?',
  );
  String get passerbyRoadFlooded => _t(
    'Is this road flooded or blocked?',
    'এই রাস্তায় কি পানি জমেছে বা আটকানো আছে?',
  );
  String get passerbyWhatSignSays =>
      _t('What does this sign say?', 'এই সাইনবোর্ডে কী লেখা আছে?');
  String get passerbyDeaf => _t(
    'I am deaf. Please type or point to answer.',
    'আমি কানে শুনি না। দয়া করে লিখে বা ইশারা করে বলুন।',
  );
  String get passerbyWhichBus =>
      _t('Which bus number is this?', 'এটি কত নম্বর বাস?');
  String get passerbyRampNearby => _t(
    'Is there a ramp or accessible entrance nearby?',
    'কাছে কোনো ঢালু পথ বা সহজ দরজা আছে কি?',
  );

  // Snapshot consent
  String get snapshotTitle => _t(
    'Can your caretaker request a photo anytime?',
    'আপনার দেখাশোনাকারী কি যেকোনো সময় ছবি চাইতে পারবেন?',
  );
  ...
  String get snapshotAlwaysDescription => _t(
    'They can request a snapshot anytime, no need to ask me first.',
    'তিনি যেকোনো সময় একটা ছবি চাইতে পারবেন, আগে জিজ্ঞেস করার দরকার নেই।',
  );
  List<String> get snapshotAlwaysSynonyms => _bn
      ? const ['সবসময়', 'যেকোনো সময়']
      : const ['always', 'anytime', 'yes always'];
  String get snapshotAskLabel =>
      _t('Ask me each time', 'প্রতিবার আমাকে জিজ্ঞেস করুন');
  String get snapshotAskDescription => _t(
    'I want to approve every snapshot request as it happens.',
    'প্রতিবার ছবি চাইলে আগে আমাকে জিজ্ঞেস করা হোক।',
  );
  List<String> get snapshotAskSynonyms => _bn
      ? const ['জিজ্ঞেস করুন', 'আগে বলুন', 'অনুমতি নিন']
      : const ['ask me', 'ask first', 'check with me'];
  String get snapshotNeverLabel => _t('Never allow', 'কখনো অনুমতি দেবেন না');
  String get snapshotNeverDescription => _t(
    'Turn off Snapshot Requests entirely.',
    'ছবি চাওয়ার সুবিধাটি পুরোপুরি বন্ধ রাখুন।',
  );
  List<String> get snapshotNeverSynonyms => _bn
      ? const ['কখনো না', 'বন্ধ রাখুন', 'বন্ধ']
      : const ['never', "don't allow", 'turn off', 'no'];

  // Safe havens
  String get safeHavensTitle =>
      _t('Where do you feel safest?', 'আপনি কোথায় সবচেয়ে নিরাপদ বোধ করেন?');
  String get safeHavensSubtitle => _t(
    'We\'ll use these to guide you back to safety and to reroute you away from danger.',
    'বিপদে পড়লে এগুলো ব্যবহার করে আমরা আপনাকে নিরাপদ জায়গায় ফিরিয়ে আনব।',
  );
  String get safeHavensHomeLabel => _t('Home address', 'বাড়ির ঠিকানা');
  String get safeHavensHomeHint =>
      _t('e.g. House 12, Road 5, Dhanmondi', 'যেমন বাড়ি ১২, রোড ৫, ধানমন্ডি');
  String get safeHavensPlaceLabel => _t(
    'A safe place nearby (optional)',
    'কাছাকাছি একটি নিরাপদ জায়গা (ইচ্ছা হলে)',
  );
  String get safeHavensPlaceHint => _t(
    'e.g. A trusted relative\'s house',
    'যেমন কোনো বিশ্বস্ত আত্মীয়ের বাড়ি',
  );
  ...
  String get safeHavensHomePromptSpoken =>
      _t('Say your home address.', 'আপনার বাড়ির ঠিকানা বলুন।');
  ...
  List<String> get safeHavensSkipWords => _bn
      ? const ['বাদ', 'নেই', 'স্কিপ']
      : const ['skip', 'none', 'no', "don't have one", 'nothing'];
  ...
  String get placesNamePromptSpoken => _t(
    'What do you want to call this place?',
    'এই জায়গাটাকে কী নামে ডাকবেন?',
  );
  ...
  List<String> get placesAddAnotherSynonyms => _bn
      ? const ['আরেকটা', 'আরও', 'আরেকটি']
      : const ['another', 'one more', 'add', 'more'];
  ...
  String get placesFieldAddressHint =>
      _t('e.g. Gulshan 1, Road 11', 'যেমন গুলশান ১, রোড ১১');
  ...
  String get commandTourTitle =>
      _t('How to talk to the app', 'অ্যাপের সাথে যেভাবে কথা বলবেন');
  ...
  List<({String heading, List<String> examples, String? note})>
  get commandTourGroups => [
    (
    ...
    (
      heading: _t(
        'To report something unsafe, say',
        'অনিরাপদ কিছু জানাতে বলুন',
      ),
      examples: [
    ...
    (
      heading: _t(
        'For help from a stranger, say',
        'অপরিচিত কারও সাহায্য পেতে বলুন',
      ),
      examples: [_t('Show my screen', 'স্ক্রিন দেখাও')],
      note: null,
    ),
  ];
  ...
  List<String> get commandTourRepeatSynonyms => _t(
    'again, repeat, one more time, say again',
    'আবার, আরেকবার, পুনরায়',
  ).split(', ');
  String get commandTourContinueLabel => _t('I am ready', 'আমি প্রস্তুত');
  List<String> get commandTourContinueSynonyms => _t(
    'ready, continue, next, ok, got it, done',
    'প্রস্তুত, ঠিক আছে, পরবর্তী, বুঝেছি',
  ).split(', ');
  ...
  String get lockInConfirmButton => _t(
    'Confirm and start using ANT',
    'নিশ্চিত করুন এবং অ্যান্ট ব্যবহার শুরু করুন',
  );
  List<String> get lockInConfirmSynonyms => _bn
      ? const ['নিশ্চিত', 'শুরু করুন', 'ঠিক আছে', 'হ্যাঁ']
      : const ['confirm', 'start', 'yes', 'done', 'lock in', 'begin'];
  ...
  String get lockInDeafLabel =>
      _t('Deaf / hard of hearing', 'কানে শোনার সমস্যা');
  ...
  String lockInContactsValue(int count) =>
      _t('$count added', '$count জন যোগ হয়েছে');
  String get lockInMessagesLabel =>
      _t('Passerby messages', 'অন্যদের জন্য বার্তা');
  String lockInMessagesValue(int count) =>
      _t('$count ready', '$count টি প্রস্তুত');
  String get lockInHomeLabel => _t('Home address', 'বাড়ির ঠিকানা');
  String get lockInSnapshotLabel =>
      _t('Snapshot permission', 'ছবি তোলার অনুমতি');
  ...
  List<String> get lockInYesSynonyms => _bn
      ? const ['জি', 'ঠিক আছে হ্যাঁ', 'হুম']
      : const ['yeah', 'yep', 'sure', 'correct', 'true'];
  String get lockInNo => _t('No', 'না');
  List<String> get lockInNoSynonyms => _bn
      ? const ['না না', 'নাহ']
      : const ['nope', 'not really', 'false', 'nah'];
  String get lockInSpokenIntro => _t(
    'Here is a summary before you confirm.',
    'নিশ্চিত করার আগে সবকিছু দেখে নিন।',
  );
  ...
  String get completeMessage => _t(
    'All set — taking you to your dashboard…',
    'সব প্রস্তুত — নিয়ে যাচ্ছি…',
  );

  // Shared
  String get backButtonSemantics =>
      _t('Go back to the previous step', 'আগের ধাপে ফিরে যান');
  String get voiceOnSemantics => _t(
    'Voice guidance is on. Double tap to turn off.',
    'ভয়েস চালু আছে। বন্ধ করতে দুইবার চাপুন।',
  );
  String get voiceOffSemantics => _t(
    'Voice guidance is off. Double tap to turn on.',
    'ভয়েস বন্ধ আছে। চালু করতে দুইবার চাপুন।',
  );
  ...
  String get voiceListeningIndicator =>
      _t('Listening for your answer…', 'আপনার উত্তর শুনছি…');
  String get voiceDictateSemantics =>
      _t('Dictate this by voice', 'কথা বলে লিখুন');
