...
class Dashboard {
  ...
  factory Dashboard.of(AppLanguage language) =>
      Dashboard._(language == AppLanguage.bangla);
  ...
  String get chatInputHint =>
      _t('Type or tap the mic…', 'লিখুন অথবা মাইকে চাপুন…');
  String get chatSpeakSemantics =>
      _t('Speak to your assistant', 'সহকারীর সাথে কথা বলুন');
  String get chatSpeakHint => _t('Tap, then speak', 'চাপুন, তারপর বলুন');
  String get chatListeningSemantics =>
      _t('Listening… tap again to stop', 'শুনছি… থামাতে আবার চাপুন');
  String get chatVoiceUnavailable => _t(
    'Voice input isn\'t available on this device.',
    'এই ডিভাইসে ভয়েস ইনপুট নেই।',
  );
  ...
  /// again, or run.
  String get emergencyActivated => _t(
    'Emergency mode. Sending alerts.',
    'জরুরি অবস্থা। সাহায্যের বার্তা পাঠানো হচ্ছে।',
  );
  ...
  String get emergencyCancelled => _t(
    'Emergency cancelled. Nothing was sent.',
    'জরুরি অবস্থা বাতিল। কিছু পাঠানো হয়নি।',
  );

  String emergencySent(int reached) => _t(
    reached == 1
        ? '1 person has been messaged.'
        : '$reached people have been messaged.',
  ...
  String get cancelWindowCancelled =>
      _t('Cancelled. Nothing was sent.', 'বাতিল হয়েছে। কিছু পাঠানো হয়নি।');
  String cancelWindowReadBack(String value) =>
      _t('You said: $value.', 'আপনি বলেছেন: $value।');
  String get chatCloseKeyboardSemantics =>
      _t('Close the keyboard', 'কীবোর্ড বন্ধ করুন');
  String get chatAssistantTyping => _t('Assistant is typing', 'সহকারী লিখছে');
  String chatYouSaid(String text) =>
      _t('You said: $text', 'আপনি বলেছেন: $text');
  String chatAssistantSaid(String text) =>
      _t('Assistant said: $text', 'সহকারী বলেছে: $text');
  ...
  String get chatStillWorking =>
      _t('Still working on that…', 'একটু সময় লাগছে…');

  String get chatAskDestination =>
      _t('Where would you like to go?', 'আপনি কোথায় যেতে চান?');
  // Suggested chips
  ...
  String get pathSheetTitle =>
      _t('Where do you want to go?', 'কোথায় যেতে চান?');
  ...
  String get pathPinOnMapHint => _t(
    'Open the map and tap where you want to go',
    'ম্যাপ খুলে যেখানে যেতে চান সেখানে চাপুন',
  );
  ...
  String chatReplyingTo(String quoted) =>
      _t('Replying to: $quoted', 'উত্তর দিচ্ছেন: $quoted');
  String get chatReplyAction =>
      _t('Reply to this message', 'এই বার্তার উত্তর দিন');
  String get chatReplyCancel => _t('Cancel reply', 'উত্তর বাতিল');
  ...
  String get settingsSavedPlaceLabelHint =>
      _t('e.g. work, my sister\'s', 'যেমন অফিস, বোনের বাসা');
  ...
  String get settingsSavedPlaceNeedsBoth => _t(
    'It needs a name and a place.',
    'একটা নাম আর একটা জায়গা — দুটোই লাগবে।',
  );
  ...
  String pathPinConfirmPrompt(String place) => _t(
    'I found $place. Is this the right place?',
    '$place পেয়েছি। এটাই কি সঠিক জায়গা?',
  );
  String get pathPinConfirmUnknown => _t(
    'I could not name this point. Use this map point anyway?',
    'এই জায়গাটির নাম খুঁজে পাইনি। তবুও কি এই পয়েন্টে যাব?',
  );
  String get pathPinUsePoint => _t('Use this point', 'এই পয়েন্ট ব্যবহার করুন');
  String get pathMapMenu => _t('Map menu', 'ম্যাপ মেনু');
  String get pathSavedPlaces => _t('Saved places', 'সেভ করা জায়গা');
  String get pathNearbyPlaces => _t('Nearby places', 'কাছাকাছি জায়গা');
  String pathCategoryLabel(String category) {
    const labels = <String, (String, String)>{
      'toilet': ('Toilets', 'শৌচাগার'),
      'pharmacy': ('Pharmacies', 'ফার্মেসি'),
      'hospital': ('Hospitals and clinics', 'হাসপাতাল ও ক্লিনিক'),
      'restaurant': ('Food and cafes', 'খাবার ও ক্যাফে'),
      'water': ('Drinking water', 'খাবার পানি'),
      'mosque': ('Mosques', 'মসজিদ'),
      'atm': ('Banks and ATMs', 'ব্যাংক ও এটিএম'),
      'bus_stop': ('Bus stops', 'বাস স্টপ'),
      'police': ('Police stations', 'থানা'),
      'shop': ('Shops', 'দোকান'),
      'bench': ('Parks and places to sit', 'পার্ক ও বসার জায়গা'),
    };
    final pair = labels[category];
    return pair == null ? category : _t(pair.$1, pair.$2);
  }
  ...
  String get pathPinInstruction => _t(
    'Move the map under the pin to choose a destination',
    'পিনের নিচে ম্যাপ সরিয়ে গন্তব্য বেছে নিন',
  );
  ...
  String get mapUnavailableSubtitle => _t(
    'A Google Maps API key hasn\'t been configured yet.',
    'মানচিত্র এখনো চালু করা হয়নি।',
  );
  ...
  String get mapResizeSemantics => _t(
    'Resize the map. Swipe up or down to adjust.',
    'মানচিত্রের আকার বদলান। উপরে বা নিচে সোয়াইপ করুন।',
  );

  String get mapExpandSemantics =>
      _t('Expand map to full screen', 'মানচিত্র পুরো স্ক্রিনে দেখুন');
  String get mapCollapseSemantics => _t(
    'Shrink map back to split view',
    'মানচিত্র আবার ভাগ করা স্ক্রিনে আনুন',
  );
  ...
  String mapRouteStatus({
    ...
    final base = _t(
      '$heading$viaClause — $remaining to go.',
      '$heading$viaClause — বাকি আছে $remaining।',
    );
    if (!safe) {
      return _t(
  ...
  String savedPlaceRouting(String label) => _t(
    'Heading to $label — I have that saved, so no need to look it up.',
    '$label-এর দিকে যাচ্ছি — এটা আমার সেভ করা আছে, খুঁজতে হবে না।',
  );

  String savedPlaceStored({
    required String label,
    required bool usedCurrentLocation,
  }) => usedCurrentLocation
      ? _t(
          'Saved where you are now as "$label". Say "take me to $label" any time.',
          'আপনি এখন যেখানে আছেন সেটা "$label" নামে সেভ করলাম। যেকোনো সময় "$label-এ নিয়ে চলো" বলুন।',
        )
      : _t(
          'Saved "$label". Say "take me to $label" any time.',
          '"$label" সেভ করলাম। যেকোনো সময় "$label-এ নিয়ে চলো" বলুন।',
        );

  String savedPlaceRemoved(String label) => _t(
    'Removed "$label" from your saved places.',
    '"$label" আপনার সেভ করা জায়গা থেকে সরিয়ে দিলাম।',
  );

  String get savedPlaceUnknown => _t(
    "I don't have a place saved by that name.",
    'ওই নামে কোনো জায়গা সেভ করা নেই।',
  );
  ...
  String savedPlaceAmbiguous(List<String> options) {
    ...
    return _t(
      'I have more than one place like that — did you mean $list?',
  ...
  String get confirmValueRetry =>
      _t('No problem — say it again.', 'সমস্যা নেই — আবার বলুন।');
  ...
  String maneuverDirection(ManeuverKind kind) => switch (kind) {
    ...
    ManeuverKind.slightRight => _t(
      'bear slightly right',
      'একটু ডান দিকে চাপুন',
    ),
    ManeuverKind.right => _t('turn right', 'ডান দিকে ঘুরুন'),
    ManeuverKind.sharpRight => _t(
      'take the sharp right',
      'জোরে ডান দিকে ঘুরুন',
    ),
    ManeuverKind.uTurn => _t('turn around', 'পেছনে ঘুরুন'),
    ManeuverKind.roundabout => _t(
  ...
  String routeSummary({
    ...
    return _t(
      'Via $via — $length, $duration.',
      '$via দিয়ে — $length, $duration।',
    );
  }

  /// Said when the user asks for a different route and there is one.
  String routeAlternativeTaken({
    required String via,
    required double distanceMeters,
    required double durationSeconds,
  }) {
  ...
  String get routeCancelled => _t(
    'Trip cancelled. Tell me where to go when you are ready.',
  ...
  String routeAlternativesRemaining(int count) => count == 0
      ...
      : _t(
          'I have $count more if you want another.',
          'আরও $count টা আছে, চাইলে বলুন।',
        );
  ...
  String navigateTurnAhead({
    ...
    return _t(
      ...
      '$distance পরে, $streetName-এ $direction।',
    );
  }
  ...
  String navigateFinalTurn({
    ...
    return streetName.isEmpty
        ? _t(
            '$direction — your destination is just ahead.',
            '$direction — গন্তব্য একদম সামনেই।',
          )
        : _t(
            '$direction onto $streetName — your destination is just ahead.',
  ...
  String get navigateStartedBrief => _t(
    'I will tell you each turn as it comes.',
    'প্রতিটি মোড় আসার আগে আমি বলে দেব।',
  );

  String get navigateStopped =>
      _t('Navigation stopped.', 'পথ দেখানো বন্ধ করলাম।');

  /// Used when a route was planned but the backend returned no manoeuvres,
  /// so there is nothing to narrate turn by turn.
  String navigateNoStepsFallback({
    required String destination,
    required double meters,
  }) => _t(
  ...
  String get passerbyPickerTitle =>
      _t('What do you need to say?', 'কী বলতে চান?');
  String get passerbyPickerSubtitle => _t(
    'Pick a message, or type your own — it\'ll show full-screen so a passerby can read it.',
    'একটি বার্তা বেছে নিন, বা নিজে লিখুন — এটি বড় করে স্ক্রিনে দেখাবে যাতে অন্য কেউ পড়তে পারে।',
  );
  String get passerbyPickerComposeHint =>
      _t('Or write your own…', 'অথবা নিজে লিখুন…');
  String get passerbyPickerShowButton => _t('Show This', 'দেখান');
  String get passerbyOverlayTapToClose =>
      _t('Tap anywhere to close.', 'বন্ধ করতে যেকোনো জায়গায় চাপুন।');
  String get passerbyOverlayShownAnnouncement => _t(
    'Showing your screen now. Say "go back" any time to return, or tap anywhere to close.',
  ...
  String get passerbyPickerContinueOrShowSpoken => _t(
    'Got it. Say more, or say "show it" to display your message now.',
  ...
  String get passerbyPickerCloseSemantics => _t(
    'Close, cancel showing a message',
    'বন্ধ করুন, বার্তা দেখানো বাতিল করুন',
  );
  String get crowdsourceOptionalDetails => _t(
    'Add any details (optional). Tap the mic to dictate.',
    'ইচ্ছা হলে আরেকটু বলুন। বলে দিতে মাইকে চাপুন।',
  );
  String get crowdsourceDescribeHint => _t(
    'Type or speak what\'s happening — we\'ll summarize it for the report.',
    'কী হচ্ছে লিখুন বা বলুন — আমরা এটি ছোট করে লিখে দেব।',
  );
  String get crowdsourceDescriptionHint =>
      _t('Describe what happened…', 'কী হয়েছে বলুন…');
  String get crowdsourceDescriptionFieldSemantics =>
      _t('Describe what happened', 'কী হয়েছে বলুন');
  String get crowdsourceSpeakSemantics =>
      _t('Speak your description', 'কথা বলে বলুন');
  String get crowdsourceAiSummaryLabel => _t(
    'AI summary (this is what gets submitted)',
    'ছোট করে লেখা (এটাই পাঠানো হবে)',
  );
  String get crowdsourceSubmitButton => _t('Submit Report', 'পাঠান');
  String get crowdsourceSubmitSuccess => _t(
    'Thanks — your report was pinned to the map.',
    'ধন্যবাদ — এটি মানচিত্রে যোগ হয়েছে।',
  );
  String crowdsourceSubmitError(String error) =>
      _t('Couldn\'t submit the report: $error', 'পাঠানো যায়নি: $error');
  ...
  String get crowdsourceSubmitQueued => _t(
    'Saved — it will reach the map as soon as you are back online.',
    'সংরক্ষণ হয়েছে — ইন্টারনেট এলে মানচিত্রে যোগ হবে।',
  );
  String get crowdsourceVoiceUnavailable => chatVoiceUnavailable;
  String crowdsourceCategoryPrompt(String optionsList) => _t(
    'Report a hazard. Choose a category: $optionsList. Say one, or tap it.',
    'বিপদ জানাতে একটি বিভাগ বেছে নিন: $optionsList। বলুন, বা চাপুন।',
  );
  String crowdsourceSubCategoryPrompt(
    String categoryLabel,
    String optionsList,
  ) => _t(
    '$categoryLabel. Choose: $optionsList. Say one, or tap it.',
  ...
  String crowdsourceCategorySelectedSpoken(String label) =>
      _t('$label selected.', '$label বেছে নেওয়া হয়েছে।');
  String get crowdsourceContinueOrSubmitSpoken => _t(
    'Got it. Say more, or say "submit" to send.',
    'ঠিক আছে। আরও বলুন, বা পাঠাতে "পাঠাও" বলুন।',
  );
  ...
  String hazardCategoryLabel(HazardCategory category) => switch (category) {
    ...
    HazardCategory.accessibilityBlock => _t(
      'Accessibility Block',
      'চলাচলে বাধা',
    ),
  };
  ...
  List<String> hazardSubCategoryKeys(HazardCategory category) =>
      switch (category) {
  ...
  String hazardSubCategoryLabel(String key) => switch (key) {
    ...
    'illegalParking' => _t(
      'Illegal Parking Blocking Path',
      'গাড়ি রাস্তা আটকে রেখেছে',
    ),
    'debrisFallenTree' => _t(
      'Debris / Fallen Tree',
      'ভাঙা জিনিস / গাছ পড়ে আছে',
    ),
  ...
  String get settingsEntrySemantics => _t(
    'My Settings — review or change what you set up during onboarding',
    'আমার সেটিংস — শুরুতে যা যা ঠিক করেছিলেন তা দেখুন বা পাল্টান',
  );
  String get settingsCouldNotLoad =>
      _t('Couldn\'t load profile', 'তথ্য আনা যায়নি');
  String get settingsPairingSection => _t('Caretaker', 'দেখাশোনাকারী');
  String get settingsPairingIntro => _t(
    'Have a caretaker now? Enter the 6-digit code from their app to link up — you can also just ask me in chat.',
  ...
  String settingsPairedWithLabel(String name) => name.isEmpty
      ? _t('Paired with a caretaker', 'একজন দেখাশোনাকারীর সাথে যুক্ত')
      : _t('Paired with $name', '$name-এর সাথে যুক্ত');
  String get settingsPairingErrorNotFound => _t(
    "Couldn't find that code. Ask your caretaker for a new one.",
    'এই কোডটি খুঁজে পাইনি। দেখাশোনাকারীকে নতুন কোড দিতে বলুন।',
  );
  String get settingsPairingErrorExpired => _t(
    'That code expired. Ask your caretaker for a new one.',
    'কোডটির মেয়াদ শেষ হয়ে গেছে। দেখাশোনাকারীকে নতুন কোড দিতে বলুন।',
  );
  String get settingsPairingErrorUsed =>
      _t('That code has already been used.', 'কোডটি আগেই ব্যবহার হয়ে গেছে।');
  String get settingsPairingErrorGeneric => _t(
  ...
  String settingsTextSizeSemantics(String scale) => _t(
    'Text size, currently $scale times normal',
    'লেখার আকার এখন স্বাভাবিকের $scale গুণ',
  );
  String get settingsMobilitySection => _t('Mobility aid', 'চলাচলে সাহায্য');
  String get settingsCognitiveSection =>
      _t('Cognitive & anxiety', 'উদ্বেগ ও চাপ');
  String get settingsCrowdedSwitch =>
      _t('Crowded places make me feel anxious', 'ভিড়ে আমার অস্বস্তি লাগে');
  String get settingsComplexSwitch => _t(
    'Complex, multi-step instructions are hard to follow',
    'অনেক ধাপের কঠিন নির্দেশ বুঝতে আমার অসুবিধা হয়',
  );
  String get settingsDeafSection =>
      _t('Deaf / hard of hearing', 'কানে কম শোনেন বা শোনেন না');
  String get settingsDeafSwitch => _t(
    'Show text and visuals instead of relying on audio',
    'শব্দের বদলে লেখা ও ছবি দেখান',
  );
  String get settingsVerbositySection =>
      _t('Assistant verbosity', 'সহকারী কতটা কথা বলবে');
  ...
  String get settingsSavedPlacesSection =>
      _t('Your saved places', 'আপনার সেভ করা জায়গা');
  ...
  String settingsSavedPlaceRemoveSemantics(String label) => _t(
    'Remove $label from your saved places',
    '$label সেভ করা জায়গা থেকে সরান',
  );
  String get settingsSavedPlaceNoAddress =>
      _t('No address saved', 'কোনো ঠিকানা সেভ নেই');

  String get settingsWakeWordSection =>
      _t('"Hey ANT" voice trigger', '"Hey ANT" ভয়েস ট্রিগার');
  String get settingsWakeWordSwitch => _t(
    'Listen for "Hey ANT" so I can talk without tapping the mic',
    '"Hey ANT" বললে মাইকে না চেপেই কথা বলা যাবে',
  );
  ...
  String settingsWakeWordLiveScore(String score) =>
      _t('Heard just now: $score', 'এইমাত্র শোনা: $score');
  ...
  String get caretakerVoiceMemoHeard => _t(
    'A voice message from your caretaker.',
    'আপনার সহায়ক একটি ভয়েস বার্তা পাঠিয়েছেন।',
  );
  ...
  String get caretakerPhotoArrived => _t(
    'Your caretaker sent a photo. Let me look at it.',
  ...
  String get photoSentToCaretaker => _t(
    'Photo sent to your caretaker.',
    'দেখাশোনাকারীকে ছবি পাঠিয়ে দিয়েছি।',
  );
  ...
  String voiceMemoReplaying(int index, int total) => total == 1
      ? _t(
          'Playing your caretaker\'s message.',
          'আপনার দেখাশোনাকারীর বার্তা শোনাচ্ছি।',
        )
      : _t(
          'Message $index of $total.',
          '$total-টির মধ্যে $index নম্বর বার্তা।',
        );
  ...
  String get caretakerMemoSent => _t(
    'Message sent to your caretaker.',
    'আপনার দেখাশোনাকারীকে বার্তা পাঠিয়েছি।',
  );
  ...
  String get forgotNote => _t(
    "Forgotten — I won't bring that up again.",
    'ভুলে গেছি — এটা আর বলব না।',
  );
  String get forgotNoteUnknown => _t(
    "I don't have anything like that written down.",
    'ওরকম কিছু আমার কাছে লেখা নেই।',
  );
  ...
  String caretakerMessageSent(String message) => _t(
    'Sent to your caretaker: "$message"',
    'আপনার দেখাশোনাকারীকে পাঠিয়েছি: "$message"',
  );
  String get caretakerMessageEmpty =>
      _t("What would you like me to tell them?", 'তাঁকে কী বলতে চান?');
  ...
  String get voiceMemoCancelled => _t(
    'Cancelled — nothing was sent.',
    'বাতিল করা হয়েছে — কিছু পাঠানো হয়নি।',
  );
  ...
  String get settingsDiagnosticsSection =>
      _t('Send a report to the developers', 'ডেভেলপারদের রিপোর্ট পাঠান');
  ...
  String settingsDiagnosticsReady(int lines) => _t(
    '$lines lines of this session are ready to send.',
    'এই সেশনের $lines লাইন পাঠানোর জন্য প্রস্তুত।',
  );
  ...
  String settingsDiagnosticsFailed(String error) => _t(
    'Could not build the report: $error',
    'রিপোর্ট তৈরি করা যায়নি: $error',
  );

  String get settingsHapticsSection =>
      _t('Vibration strength', 'কম্পনের মাত্রা');
  ...
  String get settingsAutoListenSwitch => _t(
    'Start listening automatically when a voice input opens, instead of tapping the mic first',
    'ভয়েস ইনপুট খুললে মাইকে চাপ না দিয়েই নিজে থেকে শোনা শুরু হবে',
  );
  String get settingsContactsSection =>
      _t('Magic Button contacts', 'ম্যাজিক বাটনের পরিচিতি');
  String get settingsMessagesSection =>
  ...
  String get settingsSafePlaceLabel =>
      _t('Safe place (optional)', 'নিরাপদ জায়গা (ইচ্ছা হলে)');
  ...
  String get settingsRemoveMessageSemantics =>
      _t('Remove this message', 'এই বার্তা বাদ দিন');
  String get settingsWriteMessageHint =>
      _t('Write or dictate a new message…', 'নতুন বার্তা লিখুন বা বলুন…');
  String get settingsWriteMessageSemantics =>
      _t('Write a new passerby message', 'নতুন বার্তা লিখুন');
  String get settingsSpeakMessageSemantics =>
      _t('Speak your message', 'কথা বলে বলুন');
  ...
  String get settingsFooterNote => _t(
    'Changes here save immediately.',
    'এখানে যা পাল্টাবেন সাথে সাথে সেভ হবে।',
  );

  String languageLabel(AppLanguage language) => language == AppLanguage.bangla
      ? _t('Bangla', 'বাংলা')
      : _t('English', 'ইংরেজি');
  ...
  String get visionSweepDone =>
      _t('Got it — looking now.', 'হয়েছে — এখন দেখছি।');
  ...
  String visionCountedObject(String label, int count) => count <= 1
      ? _t('a $label', '$labelটি')
      : _t('$count ${label}s', '$countটি $label');
  ...
  String visionGroundDrops(int paces) => paces <= 1
      ? _t(
          'Stop. The ground drops right in front of you.',
          'থামুন। ঠিক সামনেই নিচু হয়ে গেছে।',
        )
      : _t(
          'Careful — the ground drops about $paces paces ahead.',
  ...
  String get visionScanSemantics =>
      _t('Look around with the camera', 'ক্যামেরা দিয়ে চারপাশ দেখুন');
  ...
  String get visionLookingForRide =>
      _t('Looking for a ride…', 'একটা গাড়ি খুঁজছি…');
  ...
  String visionOfferHail(String destination) => destination.isEmpty
      ? _t('Shall I show a sign asking for a ride?', 'গাড়ি চাই লেখা দেখাব?')
      : _t(
          'Shall I show a sign asking for a ride to $destination?',
  ...
  String visionHailSign(String destination) => destination.isEmpty
      ? _t(
          'I need a ride. I cannot see.',
          'আমার একটা গাড়ি লাগবে। আমি দেখতে পাই না।',
        )
      : _t(
          'I need a ride to $destination. I cannot see.',
